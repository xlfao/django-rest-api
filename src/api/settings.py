...
SECRET_KEY = 'django-insecure-dzh+fzytmm$s*#nva1e27ag-u1k#m7om9bdbj#xh#8t=8vg5%5'
...
SITE_NAME = "Django REST API"
SITE_URL_API = os.environ.get('SITE_URL_API', 'http://localhost:6901')
